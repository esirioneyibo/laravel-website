...
<div class="head">
    <div class="container">
        <div class="row">
            <div id="head1">
                <div class="col-md-5">
                    <span class="fa" id="mailID"><i class="fa fa-envelope-o"></i>info@sanjeevnitravels.com</span>
...
<section class="welcome-box">
    <div class="container" >
        <div class="row ">
            <div class="col-sm-6 col-sm-offset-3">
                <h3 class="head-title text-center to_animate" data-animation="slideDown">Welcom to Sanjeevni Travels</h3>
        ...
        <div class="row">
            <div class="col-sm-7 to_animate" data-animation="fadeInLeft">
                <div class="slide_description_wrapper">
                    ...
                    <p>Sanjeevni Travels is the smartest way to get around. One tap and a car comes directly to you. Your driver knows exactly where to go. And you can pay with either cash or card..</p>
        ...
        <div class="row">
            ...
            <div class="col-sm-7 to_animate" data-animation="fadeInLeft">
                <div class="slide_description_wrapper">
                    ...
                    <p>Sanjeevni Travels is the fastest way to deliver your packages with minimal cost </p>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="block widget_text col-sm-6">
                ...
                <p>
                    ...
                    <strong>Email: </strong><a href="mailto:info@company.com">info@sanjeevnitravels.com</a><br>
                    <strong>Website: </strong><a href="./">http://sanjeevnitravels.com</a>
                </p>
                <h3>Find Us On</h3>
                <p id="social-bottom">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12 text-center">
                &copy; Copyright 2018-Sanjeevni Travels
            </div>
        </div>
